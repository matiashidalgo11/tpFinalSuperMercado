...
public class CrearOferta extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					CrearOferta frame = new CrearOferta(aux);
	 ...
	 * Create the frame.
	 */
	public CrearOferta(Supermercado superAux) {
	...
	public void Fondo()
	{
		...
		Fondo.setIcon(new ImageIcon(Principal.class.getResource("/img/Crear Oferta.png")));
