...
public class AgregarUsuario extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					AgregarUsuario frame = new AgregarUsuario(aux);
	 ...
	 * Create the frame.
	 */
	public AgregarUsuario(Supermercado superAux) {
	...
	public void Fondo()
	{
		...
		Fondo.setIcon(new ImageIcon(Principal.class.getResource("/img/Agregar Usuario.png")));
