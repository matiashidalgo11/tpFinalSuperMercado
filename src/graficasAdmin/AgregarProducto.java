...
public class AgregarProducto extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					AgregarProducto frame = new AgregarProducto(aux);
	 ...
	 * Create the frame.
	 */
	public AgregarProducto(Supermercado superAux) {
	...
	public void Fondo()
	{
		...
		Fondo.setIcon(new ImageIcon(Principal.class.getResource("/img/Agregar Producto.png")));
