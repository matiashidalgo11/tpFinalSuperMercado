...
public class EliminarUsuario extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					EliminarUsuario frame = new EliminarUsuario(aux);
	 ...
	 * Create the frame.
	 */
	public EliminarUsuario(Supermercado superAux) {
	...
	public void Fondo()
	{
		...
		Fondo.setIcon(new ImageIcon(Principal.class.getResource("/img/Eliminar Usuario.png")));
