...
public class ModificarProducto extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					ModificarProducto frame = new ModificarProducto(aux);
	 ...
	 * Create the frame.
	 */
	public ModificarProducto(Supermercado superAux) {
	...
	public void Fondo()
	{
		...
		Fondo.setIcon(new ImageIcon(Principal.class.getResource("/img/Modificar Producto.png")));
